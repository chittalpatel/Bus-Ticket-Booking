...
public class Bus {
    ...
    {
    	System.out.println("\t*********************************************************************************************************");
        System.out.println("\t\tOur Service covers cities : Ahmedabad, Surat, Baroda, Bhavnagar, Rajkot, Navsari \n\t\tShortly,We will Extend Our Services For Other Cities too.");
    	System.out.println("\t*********************************************************************************************************");
        ...
        if(source.equals("0"))
            return;
        while(!source.equalsIgnoreCase("ahmedabad") && !source.equalsIgnoreCase("surat") && !source.equalsIgnoreCase("baroda") && !source.equalsIgnoreCase("navsari") && !source.equalsIgnoreCase("bhavnagar") && !source.equalsIgnoreCase("rajkot"))
        {
        ...
        if(dst.equals("0"))
            return;
        while(!dst.equalsIgnoreCase("ahmedabad") && !dst.equalsIgnoreCase("surat") && !dst.equalsIgnoreCase("baroda") && !dst.equalsIgnoreCase("navsari") && !dst.equalsIgnoreCase("bhavnagar") && !dst.equalsIgnoreCase("rajkot"))
        {
        ...
        {
            System.out.println("Sorry we unable to Book Ticket For the Date provided. \nRemember We Book in Advance for next 15 days only.");
        }
        else
        {
          break; 
        ...
        //.........................take time..........................
        System.out.println("\t************ NOTE: Our Service is for Below Provided Times only. Routes with New Time will be added Shortly.*************");
        for(;;){
        try{
         ...
         //..................making of route..........................
       {
        ...
        //..............................Data Read From Date of Booking File.................
       ...
       //..........................SeatNumber Format....................
        ...
        //........................showing available and not available seat......................
        String replace[];
        ...
        for(int i=0;i<10;i++)
        {
            System.out.println("\t"+replace[5*i+1]+" "+replace[5*i+2]+"\t"+replace[5*i+3]+" "+replace[5*i+4]+" "+replace[5*i+5]);
        }
      ...
      BufferedWriter w=null;
       try{
       w=new BufferedWriter(new FileWriter("..\\Bus_Ticket_Booking\\Database\\SeatBooked\\"+date+".txt",false));
       for(int i=0;i<60;i++)
       {
           w.write(file.get(i));
           w.write("\n");
       ...
       catch(IOException e)
       {
           System.out.println("Some I/O Error Occur \n"+e);
             ...
             try{w.close();}
             catch(IOException e){  System.out.println("Some I/O Error Occur \n"+e); }
       }
